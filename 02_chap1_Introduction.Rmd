...
Taking the natural logarithm of the series is an approach to cancel out increasing volatility. 
By taking out the returns of the transformed series we can visualize volatility clusters as seen in figure .....

```{r chap1.1.1,  echo=FALSE, fig.cap="Visualization of the 4 indexes"}
