...
```{r chap1.1.2,  echo=FALSE,include=T,fig.align='center'}
...
```
\newpage
####1.1.1. transformation, volatility and clusters

Applying the natural logarithm to the series is an approach to cancel out increasing volatility. 
By taking out the returns of the transformed series we can visualize volatility clusters as seen in figure .....

```{r,chap 1.1.3,include=T, echo = F,message=F,fig.dim=c(15,15), fig.cap="Visualization log returns"}
...
>>>>>>> ba374ea26733ca4393ce4402bb15cd8c05ba40f1
