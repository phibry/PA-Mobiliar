...
The previously introduced ACF and PACF can help to choose simple models. Provided that the time series is stationary, the model orders can be determined directly. For an AR(p)-process (ARIMA(p, 0, 0))
