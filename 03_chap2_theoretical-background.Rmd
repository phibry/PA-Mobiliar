...
the scale goes from 0 to 100.  [@RSI].
...
The original developer J. Welles Wilder Jr. proposed a length of N =14 in its work from 1978[@slide_trading_indicators_univariate].
...
chartSeries(GOOGL, subset="2020-01::2020-10",type="line",theme=chartTheme("white"),name = "RSI EMA Google Nasdag",TA=NULL)
