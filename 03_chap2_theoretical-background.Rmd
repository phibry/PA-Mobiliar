...
```{r chap2.2.1, echo=FALSE, fig.cap="ARIMA-Forecast", fig.keep = 'last'}
x <- g.adj
h <- 1
...
In figure \ref{fig:chap2.2.1} you can see the prediction of the model. The whole representation is shifted by one day so that one can compare the model with a true value.
