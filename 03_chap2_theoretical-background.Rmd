...
n1=50
n2=250
chartSeries(GOOGL,type="line",subset="2015-3::2020-10",theme=chartTheme("white"),name= "MA Crossings Google Nasdag")
...
The real strength index is a tool to measure momentum, the value indicates if positions are overvalued or undervalued.
the scale goes from 0 to 100. Usually when the RSI is going over 70 it suppose taht the asset is overvalued and in contrast when its under 30 then its undervalued. 
&nbsp;

 [@slide_trading_indicators_univariate].

```{r,chap2.8 ,fig.cap="Bollinger Bands", echo=FALSE, warning=FALSE, message=FALSE, fig.keep = 'last',fig.dim=c(7,4)}
n=14
chartSeries(GOOGL, subset="2017-08::2020-10",type="line",theme=chartTheme("white"),name = "RSI Google Nasdag")
addRSI(n=n,maType="SMA")
...
```{r,chap2.9,fig.cap="MACD", echo=FALSE, warning=FALSE, message=FALSE, fig.keep = 'last',fig.dim=c(7,4)}
