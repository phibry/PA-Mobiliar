...
A skillfull trader chose an optimal $\alpha$ to increase the performance of the measurement. Weights could also be given individually by adding a weight vector to the filter.
...
\newpage
### 2.9 Moving Average Convergence Divergence
