...
lines(index_2_onebest_year[,c(2,3,5,6)],type="p",pch=3,lwd= 3,cex=2 ,col= c("red","coral","blue","cornflowerblue"))
...
addLegend("topright", on=1, legend.names = c("maximum values"), pch=3,box=T,col="black")
