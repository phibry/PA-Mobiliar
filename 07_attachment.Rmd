...
```
\newpage
```{r macrosstable 1000 x 1000  index 4, echo=FALSE}
rolf1=(as.data.frame(rolf1))[,c(1,2,3)]


kbl(rolf1[1:50,] , caption="index 4 10 best", booktabs = T, linesep = "") %>%
  kable_styling(latex_options = c("striped", "hold_position"))

kbl(rolf1[51:100,], caption="index 4 10 best", booktabs = T, linesep = "") %>%
  kable_styling(latex_options = c("striped", "hold_position"))

kbl(rolf1[101:150,], caption="index 4 10 best", booktabs = T, linesep = "") %>%
  kable_styling(latex_options = c("striped", "hold_position"))

kbl(rolf1[151:160,], caption="index 4 10 best", booktabs = T, linesep = "") %>%
  kable_styling(latex_options = c("striped", "hold_position"))
```
