...
\newpage
As noticed the Visualizations  are only done for index one, they are shown in the tables \ref{tab:macrosstable index 1},\ref{tab:macrosstable index 2},\ref{tab:macrosstable index 3},\ref{tab:macrosstable index 4}. For 
