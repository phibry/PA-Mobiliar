...
```{r, chap3.2.3.2, echo=FALSE, fig.cap="Best", fig.dim=c(11, 6), out.width = "100%"}
perfplot_sma_opt(xall=log_ret_ind, insamp="2019-01-01", res_obj=res1, inx=1)
```

\newpage

```{r restab2, echo=FALSE}
# Sharpe BnH: # 2.475576
...
Sharpe Buy and Hold: `r round(bnh_trading_sharpe_2, 3)`

Trading-Return: 105865

```{r, chap3.2.3.3, echo=FALSE, fig.cap="Sharpe | Index 2", out.width = "85%"}
plot(res_trade_2$Sharpe, type="l", main="SMA-Trading-Optimisation | Index 2", ylab="Sharpe Ratio", xlab="L", xaxt="n", col="#DF536B")
