...
plot(y_ind[,1],main="Log_returns index 1",col = 2)
plot(x_ind[,2],main="Log_returns index 2",col = 3)
plot(y_ind[,2],main="Log_returns index 2",col = 3)
plot(x_ind[,3],main="Log_returns index 3",col = 4)
plot(y_ind[,3],main="Log_returns index 3",col = 4)
plot(x_ind[,4],main="Log_returns index 4",col = 5)
plot(y_ind[,4],main="Log_returns index 4",col = 5)
