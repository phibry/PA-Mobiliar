...
```{r, chap3.5.2.2. , echo=FALSE, fig.cap="conversion data", include=T, fig.keep = 'last'}
n1=17
n2 =111
...
initialization time as the length of filter  itself. For example when the optimization
\newpage
