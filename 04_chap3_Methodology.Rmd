...
One could nearly tell just by looking at the indexes how strong they are correlated. The correlation matrix in table \ref{tab:cortable} confirms the assumption, the correlation is nearly 1 for every index to each other.
...
abline(v=c(1,151), col = "blue",lty=2)
...
axis(1, at=c(1, 76, 151), labels=c("100", "175","250"))
```  
\newpage
```{r, chap3.2.4.1.2, echo=FALSE, fig.cap="Sharpe Index 1.", include=T,out.width = "100%",fig.dim=c(16, 7.4)}
plot((ind1_opt$perf_mat)[,2],type="l",ylab="Sharpe",xlab="",main="Filter optimization start: 2015 ")
