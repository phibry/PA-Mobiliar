...
For getting a better sense the Hyperoptimazation is again calculatet, this time showing the 10 best results of every insample timespan. As we can see....
...
\newpage
As noticed the Visualizations are only done for index one, We've done the same optimization for all indexes the result are shown in the table 1.
