...
```{r chap3.2.1. share volatility equally, echo=FALSE, fig.cap=equally weighted protfolios variance",include=F}
sigmas=diag(var(ind))
sigma_shares=100*sigmas/sum(sigmas)
sigma_shares
```
 
 
THe cancel out this effect, we're going to size the position with the inverse volatility, by standardizing the conditional variance:
