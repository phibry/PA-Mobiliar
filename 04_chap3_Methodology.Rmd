...
\newpage
As noticed the Visualizations are only done for index one, We've done the same optimization for all indexes the result are shown in referenz auf tabelle
