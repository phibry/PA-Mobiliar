...
As we can see in the table the volatility of index 4 is as much as  x x xx times higher than the volatility of index 1 and the sharperatio behaves inverse to the risk.
...
################## lengths
plot(rolf1[,2],type="p",col= "red",main= "Filterlengths 10 best Hyperoptimization Index 4 ",ylim=c(-200,1010),format.labels="%b-%Y")
...
But we take the risk in good knowledge of maybe not finding the right filterlenght and use this optimization for trading the series in the next section.
