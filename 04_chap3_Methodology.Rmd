...
opt_ar_1[,2] <- round(as.numeric(opt_ar_1[,2]), 3)
kbl(opt_ar_1, caption="Solution of the AR-Modell calculation.", booktabs = T) %>%
  kable_styling(latex_options = c("striped", "hold_position"))
```
