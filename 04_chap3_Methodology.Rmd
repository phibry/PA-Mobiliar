...
Based on the optimal filterlenghts calculated in the last section the SMAs are now applied to the "out of sample" span from 2019-01-01 to 2020-04-01. Keeping in mind that the Moving Averages need the same 
initialization time as the length of filter itself, only the optimal filterlengths from years smaller than 2017 are considered
